...
function getCoverLetterTexts(languageCode: LanguageCode) {
  const texts = {
    es: {
      ...
      closing: "Estaría encantado de tener la oportunidad de discutir cómo mis habilidades se alinean con sus necesidades. Gracias por su consideración.",
    ...
    en: {
      ...
      closing: "I would welcome the opportunity to discuss how my skills align with your needs. Thank you for your consideration.",
    ...
    fr: {
      ...
      closing: "Je serais heureux d'avoir l'occasion de discuter de la façon dont mes compétences correspondent à vos besoins. Merci pour votre considération.",
    ...
    de: {
      ...
      closing: "Ich würde mich über die Gelegenheit freuen, zu besprechen, wie meine Fähigkeiten Ihren Anforderungen entsprechen. Vielen Dank für Ihre Berücksichtigung.",
    ...
    it: {
      ...
      closing: "Sarei lieto di avere l'opportunità di discutere come le mie competenze si allineano alle vostre esigenze. Grazie per la considerazione.",
    ...
    pt: {
      ...
      closing: "Gostaria de ter a oportunidade de discutir como minhas habilidades se alinham às suas necessidades. Obrigado pela consideração.",
    ...
    ja: {
      ...
      closing: "私のスキルが貴社のニーズにどのように適合するかについて話し合う機会をいただければ幸いです。ご検討いただきありがとうございます。",
      farewell: "敬具,"
    },
    hi: {
      ...
      closing: "मैं इस अवसर का स्वागत करूंगा कि कैसे मेरी क्षमताएँ आपकी आवश्यकताओं के अनुरूप हैं। विचार के लिए धन्यवाद।",
      farewell: "सादर,"
    },
    fa: {
      ...
      closing: "خوشحال می‌شوم فرصتی برای بحث دربارهٔ چگونگی هماهنگی مهارت‌هایم با نیازهای شما داشته باشم. از توجه شما سپاسگزارم.",
      farewell: "با احترام,"
    },
    ar: {
    ...
    ru: {
      ...
      closing: "Буду рад обсудить, как мои навыки соответствуют вашим потребностям. Спасибо за внимание.",
